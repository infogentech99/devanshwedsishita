...
export default function CoupleUs() {
    ...
    return (
            ...
            <div className="bg-[url('/assets/res_bg_two3.webp')] md:bg-[url('/assets/bg_two_n.webp')] bg-cover bg-no-repeat">
                <div className="flex flex-col items-center h-165 md:h-176 lg:h-318 3xl:h-403">
                  ...
                  <h2 className="font-eb-garamond font-medium text-xs md:text-2xl lg:text-3xl text-center leading-4.5 md:leading-5 lg:leading-9 pt-0 md:pt-2 lg:pt-2 text-[#B35800] md:px-0 px-20">
